    ...
    <div className="flex flex-col min-h-screen bg-white">
      <div className="flex flex-col lg:flex-row justify-between items-center mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="w-[473px] h-[562px] rounded-md">
          ...
          <p className="text-left text-base text-slight-gray">Log in to continue your journey with our products</p>
          <form>
          ...
          <p className="text-left mt-1 text-base">
            Don't have an account? <Link href="/sign-up" className="text-icha2">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
